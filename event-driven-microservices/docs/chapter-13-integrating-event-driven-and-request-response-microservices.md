...
## CHAPTER 13 Integrating Event-Driven and Request-Response Microservices: Handling External Events
...
![](../images/event_driven_microservices_page_0231_2.png)
...
![](../images/event_driven_microservices_page_0232_4.png)
...
![](../images/event_driven_microservices_page_0233_5.png)
...
![](../images/event_driven_microservices_page_0235_6.png)
...
_Figure 13-5. Using partition assignments to determine where materialized state for a_ _given key is located_
...
![](../images/event_driven_microservices_page_0237_9.png)
...
_success‐rate_ = 1/ _number_ _of_ _instances_
...
_Figure 13-7. Using the load balancer to correctly forward requests based on consumer_ _group ownership and partitioner logic_
...
![](../images/event_driven_microservices_page_0239_13.png)

_Figure 13-8. An all-in-one microservice serving from external state store; note that_ _either instance could serve the request_
...
![](../images/event_driven_microservices_page_0240_15.png)

_Figure 13-9. A microservice composed of separate executables—one for serving requests,_ _the other for processing events_
...
![](../images/event_driven_microservices_page_0241_16.png)
...
![](../images/event_driven_microservices_page_0244_19.png)

_Figure 13-11. Workflow for populating a newspaper, with gating based on approval by_ _editor and advertiser_
...
![](../images/event_driven_microservices_page_0244_20.png)
...
You may have noticed that the advertiser approvals are keyed on `pn_key` and that there will be multiple advertiser events with this same key per newspaper. In this case the advertiser approvals are being treated as _events_ and not _entities_, and it is the _aggre‐_ _gate_ of these events that determines the complete approval by an advertiser for the newspaper. Keep in mind that each advertiser logs into their GUI and approves their ads separately, and it’s not until they have all replied (or perhaps, failed to reply in time) that the process can move on to the final approval. If you take a look at the editor approval event definition, you can see that the aggregation of rejected events is represented as an array of `RejectedAdvertisements` objects.
...
![](../images/event_driven_microservices_page_0247_23.png)
...
The populated newspaper stream is the single source of truth for all _candidate_ newspapers. The editor-approved p.n. stream is the single source of truth _only for newspapers that have been approved for_ _advertiser review_, having been filtered by the editor system’s logic. The two event streams do not have the same business meaning.
...
![](../images/event_driven_microservices_page_0249_25.png)

_Figure 13-14. Three main approaches to organizing products and teams for customer-_ _facing content_
...
![](../images/event_driven_microservices_page_0252_27.png)

_Figure 13-15. Experiences search and review application, GUI mockup version 1 with_ _monolithic frontend_
...
![](../images/event_driven_microservices_page_0253_28.png)

_Figure 13-16. Experiences search and review application, GUI mockup version 2 with_ _microfrontends_
...
_Figure 13-17. The flexibility of microfrontends paired with backend event-driven micro‐_ _services_
