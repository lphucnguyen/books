...
At deployment time, the CD pipeline can read the configuration from the store and pass it to the application through environmentapp-configuration/ variables. The drawback of this approach is that the configuration cannot be changed without redeploying the application.
...
> 3“Azure App Configuration,” https://azure.microsoft.com/en-us/services/
