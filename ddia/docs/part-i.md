...
1. Chapter 1 introduces the terminology and approach that we’re going to use throughout this book. It examines what we actually mean by words like _reliability_ , _scalability_ , and _maintainability_ , and how we can try to achieve these goals. 
